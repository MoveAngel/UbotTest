...
CMD_HELP.update({
    ...
    \n\n.addfban \
    \nUsage: Add this group to the fbanlist.\
    \n\n.addgban \
    \nUsage: Add this group to the gbanlist. \
    \n\n.removefban \
    \nUsage: Remove this group from the fbanlist.\
    \n\n.removegban \
    \nUsage: Remove this group from the gbanlist."
})